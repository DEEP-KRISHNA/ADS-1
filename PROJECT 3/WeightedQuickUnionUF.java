 ...
 * type</em> (also known as the <em>disjoint-sets data type</em>). It supports
 * the <em>union</em> and <em>find</em> operations, along with a
 * <em>connected</em> operation for determining whether two sites are in the
 * same component and a <em>count</em> operation that returns the total number
 * of components.
 * <p>
 ...
 * compression). Initializing a data structure with <em>n</em> sites takes
 * linear time. Afterwards, the <em>union</em>, <em>find</em>, and
 * <em>connected</em> operations take logarithmic time (in the worst case) and
 * the <em>count</em> operation takes constant time. For alternate
 * implementations of the same API, see {@link UF}, {@link QuickFindUF}, and
 * {@link QuickUnionUF}.
 *
 * <p>
...
public class WeightedQuickUnionUF {
     ...
     * input, where each integer represents some object; if the sites are in
